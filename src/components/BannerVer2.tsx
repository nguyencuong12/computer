...
const BannerVer2 = () => {
  ...
  return (
    <div>
      <div className="text-white bg-[#f24905]  md:flex gap-8 justify-between items-center py-4 px-4 hidden rounded ">
                  ...
                  {nav.subMenu.map((sub) => {
                    return (
                      <div key={sub.id} className="text-black  min-w-[220px] ">
                        <Link href={sub.link} className="hover:bg-red duration-150 ease-in-out hover:text-white  rounded  font-semibold m-2 flex p-2">
                          {sub.title}
                        </Link>
